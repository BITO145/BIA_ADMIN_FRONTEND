...
export default function ChapterManagement() {
  ...
  const handleAddChapter = async (e) => {
    ...
    try {
      ...
      formData.append("membershipRequired", newChapter.membershipRequired); // <-- ✅ add this
  ...
  return (
    <div className="bg-white shadow rounded-lg p-6">
                  ...
                  <div className="col-span-2">
                    ...
                    <div className="flex items-center">
                      <input
                        ...
                        checked={newChapter.membershipRequired}
                        onChange={(e) =>
                          setNewChapter({
                            ...newChapter,
      ...
      {showModal && selectedChapter && (
        <div className="fixed inset-0 bg-gray-300/10 bg-opacity-60 backdrop-blur-sm flex items-center justify-center p-4 z-50">
          {" "}
          {/* Enhanced backdrop and z-index */}
          <div className="bg-white rounded-xl shadow-2xl p-6 md:p-8 max-w-2xl w-full transform transition-all duration-300 scale-100 opacity-100">
            {" "}
            ...
            {modalType === "events" ? (
              selectedChapter.events && selectedChapter.events.length > 0 ? (
                <div className="space-y-4 max-h-96 overflow-y-auto pr-2">
                  {" "}
                  {/* Added max-height and scroll for events */}
                ...
                <p className="text-gray-600 text-center py-8 text-lg">
                  No events available for this chapter.
                </p>
              )
              ...
              <ul className="space-y-4 max-h-96 overflow-y-auto pr-2">
                {" "}
                {/* Added max-height and scroll for members */}
              ...
              <p className="text-gray-600 text-center py-8 text-lg">
                No members available for this chapter.
              </p>
            )}
          </div>
        </div>
